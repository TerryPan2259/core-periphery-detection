...
const int N = 62; //number of nodes
const int M = 159;//number edges
...
{     
    ...
    int ite = 0;
    ofstream output;
    //string outfname = "polblog_glist.txt"; //output file name
    string outfname = "dolphin_glist.txt"; //output file name
...
void read_edgelist()
{
     ...
     //string fileName = "polblogs.txt";     //change file name here
     string fileName = "dolphins.txt";     //change file name here
